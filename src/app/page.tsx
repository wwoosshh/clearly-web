        ...
        <section className="pt-12 pb-16 sm:pt-24 sm:pb-32 overflow-hidden">
          <div className="mx-auto max-w-6xl px-4 sm:px-6">
            <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between lg:gap-16">
              ...
              {/* Right - Visual */}
              <div className="hidden lg:block relative w-[480px] h-[420px] flex-shrink-0">
                ...
                {/* Main card - Company profile */}
                <div className="absolute top-10 left-4 w-[300px] rounded-2xl border border-gray-200 bg-white p-5 shadow-lg shadow-gray-200/60">
